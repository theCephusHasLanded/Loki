...
const LoginPage: React.FC = () => {
  ...
  return (
    <AuthContainer>
      ...
      >
        <AuthTitle>LOKI 2032 Login</AuthTitle>
        <AuthSubtitle>Access your institutional trading account</AuthSubtitle>
        ...
        <AuthLink href="/auth/register">
          Don't have an account? Request institutional access
        </AuthLink>
      </AuthCard>
    </AuthContainer>
  );
